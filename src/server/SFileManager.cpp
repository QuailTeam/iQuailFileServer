...
std::string SFileManager::getPacthConcatStr() const {
  return "_TO_";
}

std::string SFileManager::getPatchName(const std::string &oldVersion) const {
  return oldVersion + getPacthConcatStr() + _lastVersion;
}